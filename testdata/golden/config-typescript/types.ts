...
export type ListenerConfig = TcpListenerConfig | UnixListenerConfig | SystemdListenerConfig
export type MailerConfig = StdoutMailerConfig | TestMailerConfig | SesMailerConfig
