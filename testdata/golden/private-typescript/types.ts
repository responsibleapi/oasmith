export type ApiKeyScope = 'show:create' | 'show:update' | 'episode:create' | 'episode:update' | 'episode:publish';
...
export type EpisodeProcessingStatus = 'queued' | 'processing' | 'completed' | 'failed';
